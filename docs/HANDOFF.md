...
node scripts/test-player.js    # the character: great-circle movement, coasts, transport
```
...
`__player()` (your character: position, tile, facing, camera and mode — available in every
view, since the character is always there),
