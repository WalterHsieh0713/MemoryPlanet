...
(function () {
  ...
  var THEMES = {
    meadow: {
      ...
      deep: '#167faa', shallow: '#45c6cf', foam: '#d6fff0', skirt: ['#298fa8', '#196c8d'],
    ...
    frostfall: {
      ...
      deep: '#2d7fa6', shallow: '#a4e6f0', foam: '#ffffff', skirt: ['#6aaccc', '#3d7fa3'],
      sky: 0xe6edf6, flatSky: 0xeef2f7,
      hemi: [0xeaf3ff, 0x9fb3c7, 1.15], sun: [0xf4f8ff, 1.1],
      foliage: '#dcebe6', ground: '#eef4f8', // frosted trees on snow
      tint: {
    ...
    blossom: {
      ...
      deep: '#2f8f86', shallow: '#74d6c4', foam: '#fff0f5', skirt: ['#3a9c93', '#1f6f68'],
    ...
    starlight: {
      ...
      deep: '#0d1b4a', shallow: '#2de2e6', foam: '#b9fbff', skirt: ['#1c2d78', '#0d1640'],
